...
import { Animated, PanResponder, View, Dimensions, Easing } from "react-native";
...
export default function App() {
  // Make Values and Connect to the Animated Component
  ...
  return (
    <Container>
      ...
      <Center>
        ...
        >
          <Ionicons name={icons[index]} color={GREY} size={98} />
        </IconCard>
      </Center>
      <Edge>
